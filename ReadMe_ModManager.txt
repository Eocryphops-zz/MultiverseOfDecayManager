...
=====
	...
	----
	If you have multiple mods that came packed with this, 
		then you can exclude ones you don't want to run:
	----
	...
	If you 're a modder, you make changes to a mod.xml, 
	or exclude/include one from /sodmodmanager/XmlMods/XmlFilesToExcludeFromBuilding.txt, this section is for you. 
